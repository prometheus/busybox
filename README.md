...
Based on the official `alpine:3.23.0` base image.

The `busybox` executable is replaced by the [statically linked busybox](https://pkgs.alpinelinux.org/package/edge/main/x86_64/busybox-static) from `alpine:3.23.0`.
